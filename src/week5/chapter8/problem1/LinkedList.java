package week5.chapter8.problem1;
...
public class LinkedList<E> {
    ...
    // 연습문제 Q1 : 서로 같은 노드를 찾아 가장 앞쪽의 노드만 남기고 모두 삭제하는 메서드
        ...
        while (ptr != null) {
            ...
            while (samePtr != null) {
                ...
                if(c.compare(ptr.data, samePtr.data) == 0) {
                    ...
                    remove(samePtr);
                    samePtr = tempPtr;  // 다음 노드로 이동
                } else {
                    samePtr = samePtr.next; // 다음 노드로 이동
                }
            }
            ptr = ptr.next; // 기준 -> 다음 노드로 이동
        }
        crnt = head;
    }
}